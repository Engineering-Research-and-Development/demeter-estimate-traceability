...
public class TDataManagement {
	private static final Logger log = LogManager.getLogger(TDataManagement.class);
	private static ResourceBundle properties = ResourceBundle.getBundle("resources/serviceConf");
	private static String workDir = System.getenv(properties.getString("milkquality.workDirectory"));
    	...
    	try {
	        ...
	        { 
	            case "Training": 
	            	...
	            	urlAIMTraslator = System.getenv(properties.getString("milkquality.AIMTraslatorServiceURL.Training"));
	                break; 
	            case "Prediction": 
	            	log.debug("Set PREDICTION URL for AIM Traslator");
	            	urlAIMTraslator = System.getenv(properties.getString("milkquality.AIMTraslatorServiceURL.Prediction"));
	            	break;
	        }
	        log.debug("Sending data to python executor class.");
